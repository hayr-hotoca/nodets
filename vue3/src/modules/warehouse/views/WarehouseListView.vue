...
import type { Warehouse } from '../../../shared/types/api'
  ...
  <div class="min-h-screen p-8 bg-surface-container-lowest">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      >
        ...
        <p class="text-on-surface-variant text-sm mt-1">{{ warehouse.code }}</p>
        <p class="text-on-surface-variant text-sm">{{ warehouse.location }}</p>
      </div>
    </div>
  </div>
</template>
